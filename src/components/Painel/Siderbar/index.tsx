    ...
    >
      ...
      <div className="sidebar-container">
        ...
        <nav className="sidebar-nav">
          ...
          <Link href="/painel/cursos/list" className="sidebar-link">
          ...
          <Link href="painel/alert/alert.html" className="sidebar-link">
            {/* Ícone exclamation-triangle (Heroicons) */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <Link href="painel/button/button.html" className="sidebar-link">
            {/* Ícone cursor-arrow-ripple (Heroicons) */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
